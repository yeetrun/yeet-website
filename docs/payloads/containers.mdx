...
pushed images show up locally. See [Installation](/docs/getting-started/installation)
for host setup, and [Workflows](/docs/operations/workflows) for common update
flows. ZFS is optional; see [ZFS](/docs/concepts/zfs) if you want dataset-backed
service roots.
