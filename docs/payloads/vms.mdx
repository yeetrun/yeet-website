...
A missing image is downloaded automatically on the first VM create. `yeet vm
images update` refreshes every official image family; pass a specific payload,
such as `vm://ubuntu/26.04` or `vm://nixos/26.05`, to refresh only that family.
