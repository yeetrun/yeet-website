...
`zstd`, `e2fsck`, `resize2fs`, `mount`, `umount`, `ip`, and `tic`. On
Debian/Ubuntu hosts with the required VM devices available, use
...
the guest's NixOS module own system configuration.
