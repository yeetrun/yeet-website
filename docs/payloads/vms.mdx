...
disk restore. Yeet reports a full restore as complete only after the same VM
runner remains active through the post-load stability check and the guest agent
confirms SSH readiness.
