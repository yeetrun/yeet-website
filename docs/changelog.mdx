...
- VM service networking is repaired automatically after catch restarts, host reboots, and VM setting changes, so stale service-network wiring is less likely to break DNS or service-to-service access.
