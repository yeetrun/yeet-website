...
- The release source now points at the published website changelog revision, so fresh checkouts and submodule updates match the documented `v0.8.16` changes.
