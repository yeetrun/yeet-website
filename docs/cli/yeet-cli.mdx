...
dataset name. When the selected catch host supports the current web-run RPC,
the builder checks for mounted ZFS filesystems and suggests likely dataset
roots. Pick a root to fill the service dataset path, or enter the dataset name
manually if you already know where it should live.
