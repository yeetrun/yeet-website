...
printed by `yeet init`, and confirm the catch node is tagged. For unattended
or repeatable setup, rerun init with a catch-node auth key:
...
listed in [Installation](/docs/getting-started/installation#vm-host-requirements).
