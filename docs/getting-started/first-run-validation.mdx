...
normal yeet commands use embedded tsnet.
...
```bash
yeet rm --clean-data --clean-config yeet-smoke-web
```
...
yeet rm --clean-data --clean-config yeet-smoke-script
...
yeet rm --clean-data --clean-config yeet-smoke-cron
...
yeet rm --clean-data --clean-config yeet-smoke-vm
```
...
yeet rm --clean-data --clean-config yeet-smoke-lan
```
...
yeet rm --clean-data --clean-config yeet-smoke-zfs
```
