...
Skip VMs for the first run. Containers prove the basic path with fewer host
requirements.
...
For nightly builds, upgrades, host requirements, and non-default setup, use the
[Host Setup](/docs/getting-started/host-setup).
...
If you skip that prompt during setup, create or enter the workspace before your
first deploy. This keeps local deploy state visible and easy to reuse.
